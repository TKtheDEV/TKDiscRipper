...
class DvdRipper:
    ...
    def rip_dvd(self):
        """Runs the full DVD ripping process with status updates."""
        ...
        self.tracker._update_job(self.job_id, "📀 Ripping DVD with MakeMKV...", progress=5, status="ripping")
...
if __name__ == "__main__":
    ripper = DvdRipper("/dev/sr0", "output", skip_rip=False)
    ripper.rip_dvd()
